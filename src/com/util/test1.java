...
public class test1 {
    ...
    public static void main(String[] args) throws Exception {
        test1.sshSftp("172.16.2.2", "yxxyxx", "yxxyxx", 21);
        test1.sshSftp2("172.16.2.2", "yxx", 22, "test.txt", "yxx");
    }
    ...
    private static void sftp(Session session, String uploadFileName) throws Exception {
        ...
        try {
            ...
            InputStream instream = new FileInputStream(new File("C:/test.txt"));
